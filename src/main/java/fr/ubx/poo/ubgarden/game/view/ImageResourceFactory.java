...
public class ImageResourceFactory {
    ...
    public Image getWasp(Direction direction) {return get(ImageResource.valueOf("WASP_" + direction)); }

    public Image getHornet(Direction direction) {return get(ImageResource.valueOf("HORNET_" + direction)); }
